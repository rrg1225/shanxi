...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-ICPOFSXX.mjs
...
var detectors = {};
var detectType = __name(function(text, config2) {
...
var Theme = (_a2 = class {
  ...
  updateColors() {
    var _a14, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v;
    ...
    this.xyChart = {
      ...
      dataLabelColor: ((_m = this.xyChart) == null ? void 0 : _m.dataLabelColor) || this.primaryTextColor,
      xAxisTitleColor: ((_n = this.xyChart) == null ? void 0 : _n.xAxisTitleColor) || this.primaryTextColor,
      xAxisLabelColor: ((_o = this.xyChart) == null ? void 0 : _o.xAxisLabelColor) || this.primaryTextColor,
      xAxisTickColor: ((_p = this.xyChart) == null ? void 0 : _p.xAxisTickColor) || this.primaryTextColor,
      xAxisLineColor: ((_q = this.xyChart) == null ? void 0 : _q.xAxisLineColor) || this.primaryTextColor,
      yAxisTitleColor: ((_r = this.xyChart) == null ? void 0 : _r.yAxisTitleColor) || this.primaryTextColor,
      yAxisLabelColor: ((_s = this.xyChart) == null ? void 0 : _s.yAxisLabelColor) || this.primaryTextColor,
      yAxisTickColor: ((_t = this.xyChart) == null ? void 0 : _t.yAxisTickColor) || this.primaryTextColor,
      yAxisLineColor: ((_u = this.xyChart) == null ? void 0 : _u.yAxisLineColor) || this.primaryTextColor,
      plotColorPalette: ((_v = this.xyChart) == null ? void 0 : _v.plotColorPalette) || "#FFF4DD,#FFD8B1,#FFA07A,#ECEFF1,#D6DBDF,#C3E0A8,#FFB6A4,#FFD74D,#738FA7,#FFFFF0"
    };
...
var Theme3 = (_a4 = class {
  ...
  updateColors() {
    ...
    this.xyChart = {
      ...
      yAxisTickColor: ((_t = this.xyChart) == null ? void 0 : _t.yAxisTickColor) || this.primaryTextColor,
      yAxisLineColor: ((_u = this.xyChart) == null ? void 0 : _u.yAxisLineColor) || this.primaryTextColor,
      plotColorPalette: ((_v = this.xyChart) == null ? void 0 : _v.plotColorPalette) || "#ECECFF,#8493A6,#FFC3A0,#DCDDE1,#B8E994,#D1A36F,#C3CDE6,#FFB6C1,#496078,#F8F3E3"
    };
    this.requirementBackground = this.requirementBackground || this.primaryColor;
    this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor;
    this.requirementBorderSize = this.requirementBorderSize || "1";
...
var Theme4 = (_a5 = class {
  ...
  updateColors() {
    ...
    this.xyChart = {
      ...
      yAxisTickColor: ((_t = this.xyChart) == null ? void 0 : _t.yAxisTickColor) || this.primaryTextColor,
      yAxisLineColor: ((_u = this.xyChart) == null ? void 0 : _u.yAxisLineColor) || this.primaryTextColor,
      plotColorPalette: ((_v = this.xyChart) == null ? void 0 : _v.plotColorPalette) || "#CDE498,#FF6B6B,#A0D2DB,#D7BDE2,#F0F0F0,#FFC3A0,#7FD8BE,#FF9A8B,#FAF3E0,#FFF176"
    };
    this.requirementBackground = this.requirementBackground || this.primaryColor;
    this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor;
    this.requirementBorderSize = this.requirementBorderSize || "1";
...
var sanitizeMore = __name((text, config2) => {
...
var sanitizeText = __name((text, config2) => {
  if (!text) {
    return text;
  }
...
var hasBreaks = __name((text) => {
  return lineBreakRegex.test(text);
}, "hasBreaks");
var splitBreaks = __name((text) => {
...
var katexRegex = /\$\$(.*)\$\$/g;
var hasKatex = __name((text) => {
  var _a14;
  return (((_a14 = text.match(katexRegex)) == null ? void 0 : _a14.length) ?? 0) > 0;
}, "hasKatex");
var calculateMathMLDimensions = __name(async (text, config2) => {
...
var renderKatexUnsanitized = __name(async (text, config2) => {
  if (!hasKatex(text)) {
    return text;
  }
  ...
  if (true) {
    const { default: katex } = await import("./katex-KT7JNCFB.js");
...
var renderKatexSanitized = __name(async (text, config2) => {
...
var sanitizeText3 = __name((text) => sanitizeText(text, getConfig2()), "sanitizeText");
...
//# sourceMappingURL=chunk-WXY3UPOX.js.map
