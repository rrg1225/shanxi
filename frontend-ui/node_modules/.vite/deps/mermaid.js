import {
  selectSvgElement
} from "./chunk-NJGHB6AU.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-5DUHDN3W.js";
import {
  registerLayoutLoaders
} from "./chunk-PKIB45RB.js";
import "./chunk-XRX6WHXY.js";
import "./chunk-KCGH2FSW.js";
import "./chunk-YQPZE22X.js";
import "./chunk-OQBRZU2K.js";
import "./chunk-YU54JQDW.js";
import "./chunk-COPWCGZV.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-5Y7YW33G.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import {
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-WXY3UPOX.js";
import {
  __name,
  log,
  setLogLevel
} from "./chunk-HWYQIS6M.js";
import {
  isEmpty_default
} from "./chunk-JB7NOH6Y.js";
import "./chunk-QWELSXBR.js";
import "./chunk-SYWYV5P6.js";
import "./chunk-R2W2MYM4.js";
import {
  select_default
} from "./chunk-SE7FDOSL.js";
import {
  purify
} from "./chunk-BO4JYTIG.js";
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-AHTNJAMY-WWVQR5RU.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-DWJPFMVM-6SJ6WSC2.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-SMLLAGMA-7U2A6KNQ.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-UUTBAWPF-IDFBYAFN.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-T4ZO3ILL-PHOYLA7K.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-42DDH7IO-D5QTPY7E.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-DEJITSTG-GBKNQASS.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-34T5L4WZ-TVPFHKK2.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-5P7HB3ND-J56S2CQF.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-MS252O5E-YOAVHT34.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-FGHM5R23-ZBMEKEYK.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-6PBFFD2Q-NLMBDEDO.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-HSJHXN6E-HJNVLRMC.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-FHFEXIEX-4GO3UHZR.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-QKLJ7IA2-IVAZCRFW.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-VCZTEJTY-5L6BEV6H.js");
...
var draw = __name((_text, id32, version) => {
  log.debug("rendering svg for syntax error\n");
  const svg = selectSvgElement(id32);
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-GMOUNBTQ-NXFMYVE3.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-QFDTVHPH-LV7X5BG7.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-6JOO6SKY-QYFPEZTX.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-XADWPNL6-WVKCYKNB.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-TYMM5635-L5FW7V7O.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-MMDJMWI5-WOH5MIVF.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-DXYQGD6D-6OFLPAWU.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-5BDNPKRD-HXSE3PTK.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-Q4EWVU46-KBAAIOYV.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-UXIWVN3A-PHOHVPQY.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-DHZGUBPP-5D4LK3CJ.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-G4DWMVQ6-FXKROO2E.js");
...
var id31 = "wardley-beta";
var detector31 = __name((text) => {
  return /^\s*wardley-beta/i.test(text);
}, "detector");
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-NUSXRM2D-EPUG7IEQ.js");
...
var loadRegisteredDiagrams = __name(async () => {
  ...
  const results = await Promise.allSettled(
    Object.entries(detectors).map(async ([key, { detector: detector32, loader: loader32 }]) => {
      if (!loader32) {
        return;
      }
      try {
        ...
        try {
          const { diagram: diagram2, id: id32 } = await loader32();
          registerDiagram(id32, diagram2, detector32);
        } catch (err) {
...
var Diagram = (_a = class {
  ...
  static async fromText(text, metadata = {}) {
    ...
    try {
      ...
      const loader32 = getDiagramLoader(type);
      if (!loader32) {
        throw new UnknownDiagramError(`Diagram ${type} not found.`);
      }
      const { id: id32, diagram: diagram2 } = await loader32();
      registerDiagram(id32, diagram2);
    }
  ...
  async render(id32, version) {
    await this.renderer.draw(this.text, id32, version, this);
  }
  getParser() {
    return this.parser;
  }
...
var appendDivSvgG = __name((parentRoot, id32, enclosingDivId, divStyle, svgXlink) => {
  const enclosingDiv = parentRoot.append("div");
  enclosingDiv.attr("id", enclosingDivId);
  if (divStyle) {
    enclosingDiv.attr("style", divStyle);
  }
  const svgNode = enclosingDiv.append("svg").attr("id", id32).attr("width", "100%").attr("xmlns", XMLNS_SVG_STD);
  if (svgXlink) {
...
var removeExistingElements = __name((doc, id32, divId, iFrameId) => {
  var _a2, _b, _c;
  (_a2 = doc.getElementById(id32)) == null ? void 0 : _a2.remove();
  (_b = doc.getElementById(divId)) == null ? void 0 : _b.remove();
  (_c = doc.getElementById(iFrameId)) == null ? void 0 : _c.remove();
}, "removeExistingElements");
var render = __name(async function(id32, text, svgContainingElement) {
  ...
  if (svgContainingElement !== void 0) {
    ...
    appendDivSvgG(root, id32, enclosingDivID, `font-family: ${fontFamily}`, XMLNS_XLINK_STD);
  } else {
  ...
  try {
    ...
    if (config.suppressErrorRendering) {
      ...
      errorRenderer_default.draw(text, id32, "11.14.0");
    }
    throw e;
  }
  ...
  root.select(`[id="${id32}"]`).selectAll("foreignobject > *").attr("xmlns", XMLNS_XHTML_STD);
...
var runThrowsErrors = __name(async function({ postRenderCallback, querySelector, nodes } = {
  ...
  for (const element of Array.from(nodesToProcess)) {
    ...
    try {
      const { svg, bindFunctions } = await render2(id32, txt, element);
...
var render2 = __name((id32, text, container) => {
  return new Promise((resolve, reject) => {
    const performCall = __name(() => new Promise((res, rej) => {
      mermaidAPI.render(id32, text, container).then(
        (r) => {
          res(r);
          resolve(r);
        },
